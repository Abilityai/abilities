---
name: process-miner
description: Analyze Claude Code execution logs to discover workflow patterns and generate process definitions. Use this skill to extract patterns from agent behavior, mine patterns from logs, or auto-generate workflow definitions.
allowed-tools:
  - Read
  - Write
  - Bash(python*:*)
...
- **Process YAML** - Process definitions for proven patterns
...
- Use the helper script: `python scripts/process_miner.py --help`
