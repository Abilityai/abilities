...
metadata:
  ...
  author: Ability.ai
  changelog:
    - "1.0: Initial version — full dev cycle orchestrator that runs autoplan, implement, review, cso, sync-feature-flows, and commit in sequence with human approval gates."
---
